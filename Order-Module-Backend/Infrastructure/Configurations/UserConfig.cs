...
namespace Infrastructure.Configurations
{
    public class UserConfig : IEntityTypeConfiguration<User>
    {
        public void Configure(EntityTypeBuilder<User> builder)
        {
            ...
            builder.Property(x => x.Id).HasColumnName("user_id").HasColumnType("UNIQUEIDENTIFIER");
            ...
            builder.Property(x => x.CreatedAd).HasColumnName("created_at").HasColumnType("datetime2");
